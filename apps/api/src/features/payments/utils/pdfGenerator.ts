...
export function generatePaymentReceipt(data: ReceiptData): Promise<Buffer> {
    return new Promise((resolve, reject) => {
        ...
        doc.fontSize(10)
            ...
            .text('Gestión Inteligente', 40, startY + 30);

        // Receipt Details (Right)
        doc.fontSize(10)
            .font('Helvetica-Bold')
            .fillColor(COLORS.textLight)
            .text('RECIBO DE PAGO', 400, startY, { align: 'right', width: 150 });
        doc.fontSize(14)
            .font('Helvetica')
            .fillColor(COLORS.dark)
            .text(`#${payment.id.slice(0, 8).toUpperCase()}`, 400, startY + 15, { align: 'right', width: 150 });
        doc.fontSize(9)
            .font('Helvetica')
            .fillColor(COLORS.textLight)
            .text(formatDate(new Date()), 400, startY + 35, { align: 'right', width: 150 });

        // Divider
        doc.moveTo(40, startY + 60)
        ...
        doc.lineWidth(3)
            ...
            .moveTo(72, bannerY + 40)
            .lineTo(78, bannerY + 46)
            .lineTo(88, bannerY + 34)
            .stroke();
        ...
        doc.fontSize(12)
            ...
            .text('PAGO EXITOSO', 115, bannerY + 25);
        doc.fontSize(24)
            .font('Helvetica-Bold')
            .fillColor(COLORS.dark)
            .text(formatCurrency(payment.amount), 115, bannerY + 42);
        ...
        doc.text(`Generado automáticamente por Proppio - ${companyName || 'Rent Manager'}`, 0, footerY + 30, {
            align: 'center',
        });
